{
    'name' : 'Vacuum your Shopping Cart',
    'summary' : "Clear your shopping cart with single click in Website Shop",
    'category': 'Website',
    'version': '1.0',
    ...
    'data':['website_vacuum_cart_views.xml', ],
    'description': """
After installation of this module, You can able to clear your shopping cart in Webshop.
